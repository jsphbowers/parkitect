    ...
    <section class="row px-5">
      <div class="col-md-6">
        <div class="row py-3 justify-content-center">
          ...
          <div class="col-4">
            <h4 class="m-0">Elizabeth Keyes</h4>
            <div>
              <a href="https://www.linkedin.com/in/elizabeth-k-6385b1183/"><i class="mdi mdi-linkedin fs-1 text-dark"></i></a>
              <a href="https://github.com/ElizabethKeyes"><i class="mdi mdi-github fs-1 text-dark"></i></a>
            </div>
      ...
      <div class="col-md-6">
        <div class="row py-3 justify-content-center">
          ...
          <div class="col-6">
            <h4 class="m-0">Alex Quan</h4>
            <div>
              <a href="https://www.linkedin.com/in/alex-quan-34944a105/"><i class="mdi mdi-linkedin fs-1 text-dark"></i></a>
              <a href="https://github.com/Alexmquan"><i class="mdi mdi-github fs-1 text-dark"></i></a>
            </div>
      ...
      <div class="col-md-6">
        <div class="row py-3 justify-content-center">
          ...
          <div class="col-4">
            <h4 class="m-0">Anastasiia Shaynyuk</h4>
            <div>
              <a href="https://www.linkedin.com/in/anastasiia-shaynyuk/"><i class="mdi mdi-linkedin fs-1 text-dark"></i></a>
              <a href="https://github.com/AnastasiiaShaynyuk"><i class="mdi mdi-github fs-1 text-dark"></i></a>
            </div>
      ...
      <div class="col-md-6">
        <div class="row py-3 justify-content-center">
          ...
          <div class="col-6">
            <h4 class="m-0">Joseph Bowers</h4>
            <div>
              <a href="https://www.linkedin.com/in/joseph-bowers-3a3aa05a/"><i class="mdi mdi-linkedin fs-1 text-dark"></i></a>
              <a href="https://github.com/jsphbowers"><i class="mdi mdi-github fs-1 text-dark"></i></a>
            </div>
